class Vector {
  ...
  norm2() {
    let a = this;
    if (this.n === 4) return a.x ** 2.0 + a.y ** 2.0 + a.z ** 2.0 + a.w ** 2.0;
    if (this.n === 3) return a.x ** 2.0 + a.y ** 2.0 + a.z ** 2.0;
    if (this.n === 2) return a.x ** 2.0 + a.y ** 2.0;
    if (this.n === 1) return a.x ** 2.0;
  }
